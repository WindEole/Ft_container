...
/*   Updated: 2022/12/07 00:20:22 by iderighe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
...

	{
		...
		std::cout << YELLOW << "----------------------------------------------------------------------------" << RESET << std::endl << std::endl;
		{
			...
			std::cout << FUCHSIA << "\t\t    | ----- my stack (ft) ---- |" << RESET << std::endl;
...

	{
		...
		}
		{
			...
			ft_map2.insert(ft::make_pair(5, "ROOT"));
			ft_map2.insert(ft::make_pair(2, "BEGIN"));
			ft_map2.insert(ft::make_pair(10, "END"));
			ft_map2.insert(ft::make_pair(8, "RDM"));
			ft_map2.insert(ft::make_pair(2, "NEW"));
			
			ft::map<int, std::string>::iterator ft2_it = ft_map2.begin();
			ft::map<int, std::string>::iterator ft2_ite = ft_map2.end();
			...
			ft_it--;
			ft_map2.insert(++ft2_it, ft::make_pair(7, "TEST"));
			ft2_it--;
			size_t i = 0;
		...
		}
		{
			...
			ft::map<int, std::string> ft_map2;
			ft_map2.insert(ft::make_pair(5, "ROOT"));
			ft_map2.insert(ft::make_pair(2, "Aisne"));
			ft_map2.insert(ft::make_pair(10, "Aube"));
			ft_map2.insert(ft::make_pair(8, "Ardennes"));
			ft_map2.insert(ft::make_pair(2, "NEW"));
			ft_map2.insert(ft::make_pair(15, "END"));
			ft_map2.insert(ft::make_pair(7, "Ardeche"));
			ft_map2.insert(ft::make_pair(3, "Allier"));
			ft_map2.insert(ft::make_pair(1, "BEGIN"));
			ft_map2.insert(ft::make_pair(9, "Ariege"));
			...
			ft_it--;
			ft_map2.insert(++ft2_it, ft::make_pair(12, "Aveyron"));
			ft2_it--;
		...
		}
		{
			...
			ft::map<int, std::string> ft_map;
			ft_map.insert(ft::make_pair(5, "ROOT"));
			ft_map.insert(ft::make_pair(2, "Aisne"));
			...
			ft::map<int, std::string> ft_map2(ft_it, ft_ite);
